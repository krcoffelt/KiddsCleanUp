...
export const metadata: Metadata = {
  ...
  description: `Get a free quote from ${COMPANY.name}. Serving Kansas City metro with residential and commercial cleanup, demolition, and lead-safe services. Call ${COMPANY.phone}.`,
};
