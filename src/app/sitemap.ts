...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/services/junk-removal`, lastModified: LATEST_CONTENT_DATE, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/services/lead-safe`, lastModified: SEO_EXPANSION_DATE, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/services/water-mitigation`, lastModified: SEO_EXPANSION_DATE, changeFrequency: "monthly", priority: 0.9 },
    ...SPECIALTY_SERVICE_PAGES.map((page) => ({
      url: `${baseUrl}/services/${page.slug}`,
      lastModified: UPDATED_SPECIALTY_SLUGS.has(page.slug) ? LATEST_CONTENT_DATE : SEO_EXPANSION_DATE,
    ...
    { url: `${baseUrl}/about`, lastModified: SEO_EXPANSION_DATE, changeFrequency: "monthly", priority: 0.7 },
