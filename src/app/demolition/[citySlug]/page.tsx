...
export function generateStaticParams() {
  return CITY_SERVICE_PAGES
    .filter((page) => page.service === "demolition")
...
export function generateMetadata({
  ...
  return params.then(({ citySlug }) => {
    const page = getCityServicePage("demolition", citySlug);
    ...
    return buildPageMetadata({
      ...
      path: `/demolition/${page.citySlug}`,
    });
  });
}

export default async function DemolitionCityPage({
  params,
}: {
  params: Promise<{ citySlug: string }>;
}) {
